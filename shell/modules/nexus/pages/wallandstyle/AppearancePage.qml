...
PageBase {
    ...
    property var fonts: [
        ...
        { label: qsTr("Inter"), family: "Inter", mono: false },
    ]

    property var monoFonts: [
        { label: qsTr("JetBrains Mono"), family: "JetBrains Mono", mono: true },
        { label: qsTr("Fira Code"), family: "Fira Code", mono: true },
        { label: qsTr("San Francisco Mono"), family: "SF Mono", mono: true },
        { label: qsTr("Caskaydia Cove"), family: "CaskaydiaCove NF", mono: true },
    ]
